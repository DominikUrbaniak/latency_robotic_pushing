...
def gen_object_list(number_of_objects):
    ...
    #objects.append({'name': 'translation_base', 'x_pose': -0.1+0.001, 'y_pose': 0.6-0.001+0.06, 'z_pose': 0.0, 'qx': 0.0, 'qy': 0.0, 'qz': 1.0, 'qw': 0.0})
    objects.append({'name': 'translation_base', 'x_pose': -0.1-0.02, 'y_pose': 0.6+0.02, 'z_pose': 0.0, 'qx': 0.0, 'qy': 0.0, 'qz': 1.0, 'qw': 0.0})
    return objects
